namespace PollingListener
{
	partial class Example
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_MessageCheckTimer = new System.Windows.Forms.Timer(this.components);
			...
			// m_MessageCheckTimer
			// 
			this.m_MessageCheckTimer.Interval = 10;
			this.m_MessageCheckTimer.Tick += new System.EventHandler(this.Listen_Tick);
			// 
			// Example
			// 
		...
		private System.Windows.Forms.Timer m_MessageCheckTimer;
	}
}
