...
namespace Rug.Osc.Ahoy
{
    public static class AhoyMessage
    {
        ...
        public static OscMessage CreateAhoyBroadcast(IPAddress sourceAddress)
        {
            return CreateAhoyBroadcast_Inner(AhoyConstants.Address, sourceAddress);
        }
        ...
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for CreateAhoyBroadcast
        public static OscMessage CreateAhoyBroadcast(string @namespace, IPAddress sourceAddress)
        {
            return CreateAhoyBroadcast_Inner(AhoyConstants.Address + "/" + @namespace, sourceAddress);
        }
        ...
        public static OscMessage CreateAhoyResponse(IPAddress sourceAddress, int sendPort, int listenPort, string descriptor)
        {
            return CreateAhoyResponse_Inner(AhoyConstants.Address, sourceAddress, sendPort, listenPort, descriptor);
        }
        ...
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for CreateAhoyResponse
        public static OscMessage CreateAhoyResponse(string @namespace, IPAddress sourceAddress, int sendPort, int listenPort, string descriptor)
        {
            return CreateAhoyResponse_Inner(AhoyConstants.Address + "/" + @namespace, sourceAddress, sendPort, listenPort, descriptor);
        }
