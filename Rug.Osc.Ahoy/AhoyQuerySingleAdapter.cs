...
namespace Rug.Osc.Ahoy
{
    ...
    internal class AhoyQuerySingleAdapter : IAhoyQuery
    {
        ...
        public AhoyQuerySingleAdapter(string @namespace, int serviceExpiryPeriod = AhoyConstants.DefaultServiceExpiryPeriod)
        ...
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for #ctor
        public AhoyQuerySingleAdapter(string @namespace, IPAddress networkAdapterIPAddress, int serviceExpiryPeriod = AhoyConstants.DefaultServiceExpiryPeriod)
        {
            Namespace = @namespace;
