...
namespace Rug.Osc.Ahoy
{
    ...
    internal class AhoyQuerySingleAdapter : IAhoyQuery
    {
        ...
        public AhoyQuerySingleAdapter(int serviceExpiryPeriod = 3000)
            : this(IPAddress.Any, serviceExpiryPeriod)
        {
        }
        ...
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for #ctor
        public AhoyQuerySingleAdapter(IPAddress networkAdapterIPAddress, int serviceExpiryPeriod = 3000)
        {
        ...
        private void BroadcastAhoy(OscSender sender)
        {
            ...
            OscMessage msg = AhoyMessage.CreateAhoyBroadcast(HostAddress);
        ...
        {
            return new OscSender(SendAddress, 0, IPAddress.Broadcast, AhoyConstants.AhoyBroadcastPort, OscSender.DefaultMulticastTimeToLive, OscSender.DefaultMessageBufferSize, OscSocket.DefaultPacketSize);
        }
        ...
        private void SetupListener(OscListener listener)
        {
            ...
            listener.Attach(AhoyConstants.Address, delegate (OscMessage message)
            {
