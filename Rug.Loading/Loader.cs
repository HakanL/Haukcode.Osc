...
namespace Rug.Loading
{
    ...
    public static class Loader
    {
        ...
        public static string InnerXml(this XDocument document)
        {
        ...
        /// <returns>T.</returns>
        public static T LoadObject<T>(LoadContext context, XContainer sourceNode, LoaderMode loaderMode) where T : ILoadable
        {
            T[] loaded = LoadObjects<T>(context, sourceNode, null, loaderMode);

            return loaded.Length == 0 ? default(T) : loaded[0];
        }
        ...
        /// <param name="loaderMode"></param>
        /// <returns>T.</returns>
        public static T LoadObject<T>(LoadContext context, XContainer sourceNode, string tag, LoaderMode loaderMode) where T : ILoadable
        {
        ...
        /// <param name="loaderMode"></param>
        /// <returns>T.</returns>
        public static T LoadObject<T>(LoadContext context, XContainer sourceNode, Type[] argTypes, object[] arguments, LoaderMode loaderMode) where T : ILoadable
        {
        ...
        /// <param name="loaderMode"></param>
        /// <returns>T.</returns>
        public static T LoadObject<T>(LoadContext context, XContainer sourceNode, string tag, Type[] argTypes, object[] arguments, LoaderMode loaderMode) where T : ILoadable
        {
        ...
        public static ILoadable LoadObject(Type baseType, LoadContext context, XContainer sourceNode, LoaderMode loaderMode)
        {
            ILoadable[] loaded = LoadObjects(baseType, context, sourceNode, null, loaderMode);

            return loaded.Length == 0 ? null : loaded[0];
        }

        public static ILoadable LoadObject(Type baseType, LoadContext context, XContainer sourceNode, string tag, LoaderMode loaderMode)
        {
        ...
        public static ILoadable LoadObject(Type baseType, LoadContext context, XContainer sourceNode, Type[] argTypes, object[] arguments, LoaderMode loaderMode)
        {
        ...
        public static ILoadable LoadObject(Type baseType, LoadContext context, XContainer sourceNode, string tag, Type[] argTypes, object[] arguments, LoaderMode loaderMode)
        {
        ...
        /// <param name="sourceNode">The source node.</param>
        /// <returns>T[].</returns>
        public static T[] LoadObjects<T>(LoadContext context, XContainer sourceNode, LoaderMode loaderMode) where T : ILoadable
        {
            return LoadObjects<T>(context, sourceNode, null, new Type[0], new object[0], loaderMode);
        }

        public static ILoadable[] LoadObjects(Type baseType, LoadContext context, XContainer sourceNode, LoaderMode loaderMode)
        {
        ...
        /// <param name="sourceNode">The source node.</param>
        /// <returns>T[].</returns>
        public static T[] LoadObjects<T>(LoadContext context, XContainer sourceNode, string tag, LoaderMode loaderMode) where T : ILoadable
        {
        ...
        /// <param name="arguments">The arguments.</param>
        /// <returns>T[].</returns>
        public static T[] LoadObjects<T>(LoadContext context, XContainer sourceNode, Type[] argTypes, object[] arguments, LoaderMode loaderMode) where T : ILoadable
        {
        ...
        /// <param name="loaderMode"></param>
        /// <returns>T[].</returns>
        public static T[] LoadObjects<T>(LoadContext context, XContainer sourceNode, string tag, Type[] argTypes, object[] arguments, LoaderMode loaderMode) where T : ILoadable
        {
            return LoadObjects<T>(typeof(T), context, sourceNode, tag, argTypes, arguments, loaderMode);
        }

        public static ILoadable[] LoadObjects(Type baseType, LoadContext context, XContainer sourceNode, string tag, LoaderMode loaderMode)
        {
            return LoadObjects(baseType, context, sourceNode, tag, new Type[0], new object[0], loaderMode);
        }

        public static ILoadable[] LoadObjects(Type baseType, LoadContext context, XContainer sourceNode, Type[] argTypes, object[] arguments, LoaderMode loaderMode)
        {
            return LoadObjects(baseType, context, sourceNode, null, argTypes, arguments, loaderMode);
        }

        public static ILoadable[] LoadObjects(Type baseType, LoadContext context, XContainer sourceNode, string tag, Type[] argTypes, object[] arguments, LoaderMode loaderMode)
        {
        ...
        public static void SaveObject(LoadContext context, XContainer parent, object obj)
        {
        ...
        public static void SaveObject(LoadContext context, XContainer parent, string tag, object obj)
        {
            if (obj is ILoadable == false)
            {
                throw new Exception("Object is not loadable");
            }


            ILoadable loadable = (ILoadable) obj;
            ...
            if (Helper.IsNullOrEmpty(tag) == false)
            {
                ...
                element.Add(new XAttribute("Type", name));
            }
            else
            {
                element = new XElement(ToXmlNodeName(name));
            }
        ...
        public static void SaveObjects(LoadContext context, XContainer parent, System.Collections.IEnumerable objects)
        {
        ...
        /// <param name="tag">The tag.</param>
        /// <param name="objects">The objects.</param>
        public static void SaveObjects(LoadContext context, XContainer parent, string collectionName, string tag, System.Collections.IEnumerable objects)
        {
            XContainer element;

            if (Helper.IsNullOrEmpty(collectionName) == false)
            {
                element = new XElement(collectionName);
        ...
        /// <param name="tag">The tag.</param>
        /// <param name="objects">The objects.</param>
        public static void SaveObjects(LoadContext context, XContainer parent, string collectionName, string tag, params object[] objects)
        {
            XContainer element;
        ...
        {
            return TypeToNameLookup.TryGetValue(type, out name);
        }

        private static T[] LoadObjects<T>(Type baseType, LoadContext context, XContainer sourceNode, string tag, Type[] argTypes, object[] arguments, LoaderMode loaderMode) where T : ILoadable
        {
            if (sourceNode == null)
            {
            ...
            List<XElement> nodes = new List<XElement>(hasTag ? sourceNode.Elements(tag) : sourceNode.Elements());

            if (nodes.Count == 0)
            {
                context.Error(hasTag ?
                    $@"Cannot find any node with the ""{tag}"" is not valid in this context." :
                    $@"Node ""{(sourceNode as XElement)?.Name ?? "XDocument"}"" has zero children.",
                    sourceNode);
            ...
            foreach (XElement node in nodes)
            {
                ...
                XAttribute typeAttribute = node.Attribute("Type") ?? node.Attribute("type");
                ...
                else if (types.TryGetValue(node.Name.ToString(), out type) == false)
                {
                    switch (loaderMode)
                    {
